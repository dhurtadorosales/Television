<%@ Page Title="" Language="VB" MasterPageFile="~/recursos/plantillas/cabecera.master" AutoEventWireup="false" CodeFile="mega.aspx.vb" Inherits="Default3" %>
...
<asp:Content ID="mega" ContentPlaceHolderID="mega" Runat="Server">
    <figure>
        <img src="../../imagenes/mega.png" alt="Antena 3" class="logoCanal"/><br />
    </figure>
...
<asp:SqlDataSource ID="sqlDtsProgramacion" runat="server" 
    ...
    SelectCommand="SELECT Parrilla.hora, Programas.programa, Programas.imagen, Programas.comentario FROM Parrilla INNER JOIN Programas ON Parrilla.idPrograma = Programas.idPrograma WHERE (Parrilla.idCadena = 4) AND (Parrilla.fecha = @fecha)">
    <SelectParameters>
